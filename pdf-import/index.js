...
var linkedin_pdf_to_json_1 = require("linkedin-pdf-to-json");
...
var PDFParser = /** @class */ (function () {
    ...
    // }
    // Method to read a PDF from a File object in the browser
    PDFParser.prototype.readFile = function (fileName) {
        return __awaiter(this, void 0, void 0, function () {
            var linkedinPdfToJson, inputFilePath, outputFilePath, options, data, jsonData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        linkedinPdfToJson = new linkedin_pdf_to_json_1.default();
                        inputFilePath = fileName;
                        outputFilePath = "temp/data.json";
                        options = {
                            space: 4 // Define the space for JSON formatting directly here
                        };
                        data = linkedinPdfToJson.run(inputFilePath, outputFilePath, options);
                        return [4 /*yield*/, node_fs_1.promises.readFile(outputFilePath, { encoding: 'utf8' })];
                    case 1:
                        jsonData = _a.sent();
                        // Parse the JSON string back into an object to return
